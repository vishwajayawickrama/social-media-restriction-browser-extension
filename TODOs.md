...
- Show a themed in-page toast when a blocked tracked site is closed, including the next available reset time.
- Add usage analytics:
...
- Add a lightweight manual QA checklist for loading, popup behavior, settings behavior, and blocked-state behavior.
